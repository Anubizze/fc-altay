...
export async function generateMetadata({
  ...
  const descriptions: Record<AppLocale, string> = {
    ru:
      "ФК «Алтай» (Өскемен): новости по категориям, команды клуба, расписание и результаты с протоколами, таблица, медиа, партнёры, документы PDF, CMS.",
    kk:
      "«Алтай» ФК (Өскемен): санаттар бойынша жаңалықтар, клуб командалары, кесте мен хаттамалы нәтижелер, кесте, медиа, серіктестер, PDF құжаттар."
  };
  return {
    title: titles[locale],
