...
export default function HomePage({ params }: { params: { locale: string } }) {
  ...
  const sliderSlides = newsItems.slice(0, 5).map((n) => ({
    title: n.title,
    excerpt: n.excerpt,
          ...
          <div className="hero-ref">
            <div className="hero-ref__inner">
              <div className="hero-ref__tags">
                <span className="hero-ref__tag">Сезон 2026</span>
                <span className="hero-ref__tag">Первая лига</span>
                <span className="hero-ref__tag">Қазақстан</span>
              </div>
              <h1>{locale === "kk" ? "«Алтай» футбол клубы" : "Футбольный клуб «Алтай»"}</h1>
              <p>
                {locale === "kk"
                  ? "Ресми сайт: жаңалықтар, алдағы ойын, слайдер, турнир кестесі, серіктестер — қазақ және орыс тілдерінде."
                  : "Официальный сайт клуба: слайдер новостей, ближайший матч, последние новости, турнирная таблица, партнёры — на русском и казахском."}
              </p>
